...
function Testimonials() {
  ...
  return (
    <section className="py-20 bg-white max-w-[70rem] mx-auto px-6 flex flex-col lg:flex-row items-start lg:items-start justify-between gap-16">
      {/* Left Side */}
      ...
      <div className="flex-1 w-full relative flex flex-col items-center">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 relative z-10 max-w-md w-full">
          <img
            ...
            alt={active.name}
            className="w-17 h-17 sm:w-18 sm:h-18 rounded-full absolute -top-7 left-6 sm:left-[-28px] border-4 border-white object-cover"
          />
