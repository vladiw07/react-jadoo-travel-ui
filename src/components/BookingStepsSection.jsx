  ...
  <div className="relative z-10 bg-white rounded-3xl shadow-xl overflow-hidden w-full max-w-[370px] mx-auto pt-4">
    ...
    <div className="p-5 text-left space-y-2">
      ...
      <div className="flex flex-wrap items-center gap-4 mt-3 text-[#5E6282] text-sm">
        <img src={`${process.env.PUBLIC_URL}/Images/LEAF.png`} alt="" />
        <img src={`${process.env.PUBLIC_URL}/Images/map icon.png`} alt="" />
        <img src={`${process.env.PUBLIC_URL}/Images/send.png`} alt="" />
      </div>
      <div className="flex items-center gap-4 mt-3">
        <img className="h-4" src={`${process.env.PUBLIC_URL}/Images/Group.png`} alt="" />
        <p className="text-sm text-[#5E6282] font-poppins">24 people going</p>
      </div>
    </div>
  </div>

  {/* Floating status card – responsive positioning */}
  <div className="absolute -bottom-24 md:bottom-16 lg:bottom-16 xl:bottom-16  right-0 sm:-right-8 z-20 bg-white shadow-lg rounded-2xl px-4 py-3 w-[90%] max-w-[220px] text-left flex gap-4">
    <div>
      <img src={`${process.env.PUBLIC_URL}/Images/Mask Group.png`} alt="" />
    </div>
    <div>
      ...
      <p className="text-[14px] font-poppins">
        ...
        <img src={`${process.env.PUBLIC_URL}/Images/Group 3.png`} alt="" />
      </p>
    </div>
  </div>
</div>
